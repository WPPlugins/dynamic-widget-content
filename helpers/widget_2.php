...
class DWC_Widget_2 extends WP_Widget {

    public function __construct()
    {
        parent::__construct(
            'dwc_widget_2',
            'Dynamic Widget Content (2)',
            array(
    ...
    public function widget( $args, $instance )
    {
        ...
        // Get data
        $title = get_post_meta( $post_id, 'dwc-title-2', true );
        $content = get_post_meta( $post_id, 'dwc-content-2', true );
...
add_action( 'widgets_init', create_function( '', 'return register_widget("DWC_Widget_2");' ) );